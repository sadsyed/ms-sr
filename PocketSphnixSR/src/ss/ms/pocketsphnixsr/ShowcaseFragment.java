...
public abstract class ShowcaseFragment extends Fragment implements
    ...
    public void onStart() {
        super.onStart();
        recognizer = ((MainActivity) context).getRecognizer();
        recognizer.addListener(this);
        recognizer.setSearch(MainActivity.KWS_SRCH_NAME);
        sleeping = true;
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        //if (sleeping && hypothesis.getHypstr().equals(MainActivity.KEYPHRASE))
        if (sleeping)
